...
public class CustomAdapter2 extends RecyclerView.Adapter<CustomAdapter2.ViewHolder> {
    ...
    Context context;
    String [] url;
    private  RecycleViewOnItemClick2 recycleViewOnItemClick;

    public CustomAdapter2(Context ct, String []s1,String []s2,int []img,String [] url,RecycleViewOnItemClick2 recycleViewOnItemClick)
    {
        this.context =ct;
        this.data1 =s1;
        this.data2 =s2;
